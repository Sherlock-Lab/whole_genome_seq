...
p = ggplot(dat2)+geom_point(aes(x=win.start, y=counts, color=chrom))+ylim(0, y_axis_limit)+facet_wrap(~chrom, ncol=4, scale="free")+theme_bw()+theme(legend.position="none")
